...
\newcommand{\SurnameAuthor}{Hural}
\newcommand{\IdAuthor}{302037}   % numer albumu  (bez $\langle$ i $\rangle$)
...
\newcommand{\Title}{Wykrywanie prób oszustwa i obchodzenia systemu płatności w komunikacji użytkowników aplikacji C2C z wykorzystaniem analizy tekstu oraz uczenia maszynowego}           % tytuł pracy po polsku
\newcommand{\TitleAlt}{Detection of Fraud Attempts and Payment System Evasion in User Communication within C2C Applications Using Text Analysis and Machine Learning}                     % thesis title in English
