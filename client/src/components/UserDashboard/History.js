...
const History = () => {
    ...
    return (
        <>
        <h1 className='text-4xl font-bold mb-4'>Your orders history</h1>
        <h1 className='text-xl font-bold mb-2 text-orange-600'>we keep your order history for 7 days.</h1>
        <hr />
