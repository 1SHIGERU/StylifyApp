               ...
               <div class="font-[sans-serif] pt-32">
                    ...
                    <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
                         ...
                         <div class="flex items-center">
                              <input id="remember-me" name="remember-me" type="checkbox" class="accent-black h-4 w-4 text-[#8B4513] focus:ring-[#8B4513] border-[#8B4513] rounded" />
                                   <label for="remember-me" class="ml-3 block text-sm">
                                   Remember me
                                   </label>
                         </div>
                         <div class="text-sm">
                              <a class="text-[#8B4513] hover:font-bold">
